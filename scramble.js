const msg = document.querySelector('.msg');//isme we write class ka naam
...
//newwords will give any randomnumer => name of word
 //koi bhi word ko split krke array me convert krna ho to .split("") and join for vice versa now apan ko aapas characters ko shuffle krna h we will use scrambleword
...
btn.addEventListener('click',function(){if(!play){
    ...
    btn.innerHTML="Guess";//btm ka inner html change kar diya to guess and 
